...
(2.96% of frame width, windowed block motion), visibly wrong on a clip that pans (11.65%).
Raising the search range does not help — the search window is a ruled-out hypothesis, not
